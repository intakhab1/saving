                    ...
                    children: [
                      SizedBox(
                        ...
                        child: FloatingActionButton(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(
                                context, TargetCategoryScreen.routeName);
                          },
                        ),
                      ),
                      SizedBox(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: FloatingActionButton(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(
                                context, CreateSavingScreen.routeName);
                          },
                        ),
                      ),
                      SizedBox(
              ...
              items: [
                BottomNavigationBarItem(
                  title: Text(
                    ...
                    style: boldBaseFont.copyWith(
                      fontSize: 11,
                      color: (navigationProvider.index == 0)
                          ? baseColor
                          : greyColor,
                    ),
                  ),
                ...
                BottomNavigationBarItem(
                  title: Text(
                    ...
                    style: boldBaseFont.copyWith(
                      fontSize: 11,
                      color: (navigationProvider.index == 1)
                          ? baseColor
                          : greyColor,
                    ),
                  ),
                  icon: Container(
                    ...
                    height: 28,
                    child: SvgPicture.asset(
                      (navigationProvider.index == 1)
                          ? "assets/svg/ic_list.svg"
                          : "assets/svg/ic_list_grey.svg",
                    ),
                  ),
                ),
              ],
