...
class DetailTargetScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<History> histories =
        Hive.box<History>('histories').values.where((history) {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  "Progress has reached ${getPercent(argument.currentMoney, argument.nominal)}%\nof the total target",
                                  style: boldBaseFont.copyWith(
                                    fontSize: 14,
                                  ),
                                ),
